...
def seed():
    ...
    if not admin:
        ...
        # Em produção, ADMIN_EMAIL e ADMIN_PASSWORD no Render são a fonte de verdade.
        # Assim, se você trocar a senha nas variáveis do Render, o próximo deploy
        # atualiza o acesso do administrador automaticamente.
        admin.role = "admin"
        admin.set_password(admin_password)
